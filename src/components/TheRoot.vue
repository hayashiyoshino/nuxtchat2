<template>
  <section>
    ...
    <div v-if="user">
      <a
        :href="'https://twitter.com/intent/tweet?text=nuxtchatoで遊ぼう！%20%23チャット%20%23nuxtchat&url=' + encodeURIComponent(
    ...
    <div class="description">
      <p>nuxtchatはチャットすることができるサービスです。</p>
      <p>ルームを作成してリンクを共有すると、チャットすることができます。</p>
